...
## 4d)
Question: Did the deaths in US increase during the World War II? Even if the war did not affect US on a large scale. Calculate the average number of deaths during World War II and non-World War II years. 

Tip: Use variable "Total.deaths....Deaths".

Whether the World War II had influences to the deaths in a less affected country, which makes me curious.
